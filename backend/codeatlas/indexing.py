...
from .models import CodeChunkRecord, IndexGeneration, IndexJob, Repository
    ...
    def _index(self, job_id: str) -> None:
        ...
        try:
            ...
            root, commit = sync_repository(
                self.settings, repository_id, job_id, git_url, branch
            )
            checkout_path = root
            ...
            store.add_generation(chunks, EmbeddingClient(self.settings))
